...
export default function Profile() {
  ...
  const list = [
    ...
    { name: "Change Password", icon: <FormOutlined /> },
    { name: "My Order", icon: <OrderedListOutlined /> },
  ];
  return (
    <div className="fixed w-full">
      <Navbar SlideCategory={false} />
      <nav
        id="sidenav-1"
      ...
      >
        <ul class="relative m-0 list-none px-[0.2rem]" data-te-sidenav-menu-ref>
          {list.map((item, index) => (
            ...
            >
              <a
                class="flex h-12 items-center cursor-pointer truncate rounded-[5px] px-6 py-4 text-[0.875rem] text-gray-600 outline-none transition duration-300 ease-linear hover:bg-slate-50 hover:text-inherit hover:outline-none focus:bg-slate-50 focus:text-inherit focus:outline-none active:bg-slate-50 active:text-inherit active:outline-none data-[te-sidenav-state-active]:text-inherit data-[te-sidenav-state-focus]:outline-none motion-reduce:transition-none dark:text-gray-300 dark:hover:bg-white/10 dark:focus:bg-white/10 dark:active:bg-white/10"
      ...
      <div>
        <button
          class="m-3 rounded bg-[#e5be70] w-12 p-1 text-xl font-medium uppercase text-black transition duration-150 ease-in-out"
        ...
        <div className="p-3 overflow-auto">
          {pages === "Profile" ? (
            <div
              style={{ height: "100vh", overflow: "auto", paddingBottom: 150 }}
            >
              <MyProfile />
            </div>
          ) : (
